...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-time-tracker', __webpack_require__(3));
    Vue.component('detail-time-tracker', __webpack_require__(6));
    Vue.component('form-time-tracker', __webpack_require__(9));
});
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c(
        "div",
        { staticClass: "max-w-sm rounded overflow-hidden timetracker" },
        [
          _c(
            "div",
            { staticClass: "w-full relative flex justify-center items-center" },
            [
              _c("img", {
                staticClass: "w-full unsplash",
                attrs: {
              ...
              _c("div", { staticClass: "absolute" }, [
                _c("h3", { staticClass: "text-white text-center bold" }, [
                  _vm._v("Time")
                ]),
                _vm._v(" "),
                _c(
                  "h1",
                  {
                    staticClass: " text-white text-5xl",
                    staticStyle: { "margin-top": "10px" }
                  },
                  [
                    _vm._v(
                      _vm._s(_vm._f("addZero")(_vm.seconds)) +
                        ":" +
                        _vm._s(_vm._f("addZero")(_vm.minutes)) +
                        ":" +
                        _vm._s(_vm._f("addZero")(_vm.hours))
                    )
                  ]
                )
              ])
          ...
          _vm._v(" "),
          _c("div", { staticClass: "px-6 py-4 flex justify-around" }, [
            _vm.interval
              ? _c(
                  "span",
                  {
                        ...
                        _c("g", [
                          _c("g", [
                            _c("path", {
                              attrs: {
                                d:
                                  "M256,0C114.625,0,0,114.609,0,256c0,141.375,114.625,256,256,256s256-114.625,256-256C512,114.609,397.375,0,256,0z     M256,448c-106.031,0-192-85.969-192-192S149.969,64,256,64c106.03,0,192,85.969,192,192S362.031,448,256,448z M160,320h64V192    h-64V320z M288,320h64V192h-64V320z"
                              }
                            })
                          ])
                        ])
                    ...
                    _c(
                      ...
                      [
                        _c("path", {
                          attrs: {
                            d:
                              "M256,512C114.625,512,0,397.375,0,256C0,114.609,114.625,0,256,0s256,114.609,256,256C512,397.375,397.375,512,256,512z   M256,64C149.969,64,64,149.969,64,256s85.969,192,192,192c106.03,0,192-85.969,192-192S362.031,64,256,64z M192,160l160,96l-160,96  V160z"
                          }
                        })
                      ]
                    )
